...
rc_file_name=".AirHackrc"
alternative_rc_file_name="AirHackrc"
...
github_repository="AirHack"
branch="master"
script_filename="AirHack.sh"
...
urlmerchandising_shop="https://AirHack.creator-spring.com/"
mail="blackgonza@gmail.com"
author="BlackGonza"
...
#Tmux vars
session_name="AirHack"
tmux_main_window="AirHack-Main"
no_hardcore_exit=0
...
function language_strings_handling_messages() {
	...
	language_strings_try_to_download["ENGLISH"]="AirHack will try to download the language strings file..."
	language_strings_try_to_download["SPANISH"]="AirHack intentará descargar el fichero de traducciones..."
	language_strings_try_to_download["FRENCH"]="AirHack va essayer de télécharger les fichiers de traductions..."
	language_strings_try_to_download["CATALAN"]="AirHack intentarà descarregar el fitxer de traduccions..."
	language_strings_try_to_download["PORTUGUESE"]="O AirHack tentará baixar o arquivo de tradução..."
	language_strings_try_to_download["RUSSIAN"]="AirHack попытается загрузить языковой файл..."
	language_strings_try_to_download["GREEK"]="Το AirHack θα προσπαθήσει να κατεβάσει το αρχείο γλωσσών..."
	language_strings_try_to_download["ITALIAN"]="AirHack cercherá di scaricare il file delle traduzioni..."
	language_strings_try_to_download["POLISH"]="AirHack spróbuje pobrać plik tłumaczeń..."
	language_strings_try_to_download["GERMAN"]="AirHack wird versuchen, die Übersetzungsdatei herunterzuladen..."
	language_strings_try_to_download["TURKISH"]="AirHack çeviri dosyasını indirmeye çalışacak..."
	language_strings_try_to_download["ARABIC"]="سيحاول AirHack تنزيل ملف سلاسل اللغة ..."
	language_strings_try_to_download["CHINESE"]="AirHack 将尝试下载语言支持文件..."
	...
	language_strings_first_time["ENGLISH"]="If you are seeing this message after an automatic update, don't be scared! It's probably because AirHack has different file structure since version 6.1. It will be automatically fixed"
	language_strings_first_time["SPANISH"]="Si estás viendo este mensaje tras una actualización automática, ¡no te asustes! probablemente es porque a partir de la versión 6.1 la estructura de ficheros de AirHack ha cambiado. Se reparará automáticamente"
	language_strings_first_time["FRENCH"]="Si vous voyez ce message après une mise à jour automatique ne vous inquiétez pas! A partir de la version 6.1 la structure de fichier d'AirHack a changé. L'ajustement se fera automatiquement"
	language_strings_first_time["CATALAN"]="Si estàs veient aquest missatge després d'una actualització automàtica, no t'espantis! probablement és perquè a partir de la versió 6.1 l'estructura de fitxers de AirHack ha canviat. Es repararà automàticament"
	language_strings_first_time["PORTUGUESE"]="Se você está vendo esta mensagem depois de uma atualização automática, não tenha medo! A partir da versão 6.1 da estrutura de arquivos do AirHack mudou. Isso será corrigido automaticamente"
	language_strings_first_time["RUSSIAN"]="Если вы видите это сообщение после автоматического обновления, не переживайте! Вероятно, это объясняется тем, что, начиная с версии 6.1, AirHack имеет другую структуру файлов. Проблема будет разрешена автоматически"
	language_strings_first_time["GREEK"]="Εάν βλέπετε αυτό το μήνυμα μετά από κάποια αυτόματη ενημέρωση, μην τρομάξετε! Πιθανόν είναι λόγω της διαφορετικής δομής του AirHack μετά από την έκδοση 6.1. Θα επιδιορθωθεί αυτόματα"
	language_strings_first_time["ITALIAN"]="Se stai vedendo questo messaggio dopo un aggiornamento automatico, niente panico! probabilmente è perché a partire dalla versione 6.1 é cambiata la struttura dei file di AirHack. Sarà riparato automaticamente"
	language_strings_first_time["POLISH"]="Jeśli widzisz tę wiadomość po automatycznej aktualizacji, nie obawiaj się! To prawdopodobnie dlatego, że w wersji 6.1 zmieniła się struktura plików AirHack. Naprawi się automatycznie"
	language_strings_first_time["GERMAN"]="Wenn Sie diese Nachricht nach einem automatischen Update sehen, haben Sie keine Angst! Das liegt vermutlich daran, dass ab Version 6.1 die Dateistruktur von AirHack geändert wurde. Es wird automatisch repariert"
	language_strings_first_time["TURKISH"]="Otomatik bir güncellemeden sonra bu mesajı görüyorsanız, korkmayın! muhtemelen 6.1 sürümünden itibaren AirHack dosya yapısı değişmiştir. Otomatik olarak tamir edilecektir"
	language_strings_first_time["ARABIC"]="إذا كنت ترى هذه الرسالة بعد التحديث التلقائي ، فلا تخف! ربما يرجع السبب في ذلك إلى أن AirHack له بنية ملفات مختلفة منذ الإصدار 6.1. سيتم إصلاحه تلقائيًا "
	language_strings_first_time["CHINESE"]="如果您在自动更新后看到此消息，请不要害怕！这可能是因为 AirHack 从 6.1 版本开始有不同的文件结构。会自动修复"

	declare -gA language_strings_exiting
	language_strings_exiting["ENGLISH"]="Exiting AirHack script v${AirHack_version} - See you soon! :)"
	language_strings_exiting["SPANISH"]="Saliendo de AirHack script v${AirHack_version} - Nos vemos pronto! :)"
	language_strings_exiting["FRENCH"]="Fermeture du script AirHack v${AirHack_version} - A bientôt! :)"
	language_strings_exiting["CATALAN"]="Sortint de AirHack script v${AirHack_version} - Ens veiem aviat! :)"
	language_strings_exiting["PORTUGUESE"]="Saindo do script AirHack v${AirHack_version} - Até breve! :)"
	language_strings_exiting["RUSSIAN"]="Выход из скрипта AirHack v${AirHack_version} - До встречи! :)"
	language_strings_exiting["GREEK"]="Κλείσιμο του AirHack v${AirHack_version} - Αντίο :)"
	language_strings_exiting["ITALIAN"]="Uscendo dallo script AirHack v${AirHack_version} - A presto! :)"
	language_strings_exiting["POLISH"]="Wyjście z skryptu AirHack v${AirHack_version} - Do zobaczenia wkrótce! :)"
	language_strings_exiting["GERMAN"]="Sie verlassen AirHack v${AirHack_version} - Bis bald! :)"
	language_strings_exiting["TURKISH"]="AirHack yazılımından çıkış yapılıyor v${AirHack_version} - Yakında görüşürüz! :)"
	language_strings_exiting["ARABIC"]="الخروج من البرنامج AirHack v${AirHack_version}- نراكم قريبًا! :)"
	language_strings_exiting["CHINESE"]="退出 AirHack 脚本 v${AirHack_version} - 待会见！ :)"
...
function option_toggle() {
	...
	case "${option_var_name}" in
		"AirHack_BASIC_COLORS")
			remap_colors
		;;
		"AirHack_EXTENDED_COLORS")
			initialize_extended_colorized_output
		;;
		"AirHack_5GHZ_ENABLED")
...
function debug_print() {
	...
	if "${AirHack_DEBUG_MODE:-true}"; then
...
function special_text_missed_optional_tool() {
	...
	if ! "${AirHack_DEVELOPMENT_MODE:-false}"; then
...
function get_5ghz_band_info_from_phy_interface() {
	...
	if iw phy "${1}" info 2> /dev/null | grep "5200 MHz" > /dev/null; then
		if "${AirHack_5GHZ_ENABLED:-true}"; then
			return 0
		else
			return 2
		fi
	...
	case ${option_selected} in
		...
		2)
			if "${AirHack_AUTO_UPDATE:-true}"; then
				ask_yesno 457 "no"
				if [ "${yesno}" = "y" ]; then
					if option_toggle "AirHack_AUTO_UPDATE"; then
						echo
		...
		3)
			if "${AirHack_SKIP_INTRO:-true}"; then
				ask_yesno 569 "yes"
				if [ "${yesno}" = "y" ]; then
					if option_toggle "AirHack_SKIP_INTRO"; then
						echo
		...
		4)
			if "${AirHack_BASIC_COLORS:-true}"; then
				ask_yesno 558 "yes"
				if [ "${yesno}" = "y" ]; then
					if option_toggle "AirHack_BASIC_COLORS"; then
						echo
		...
		5)
			...
			if "${AirHack_EXTENDED_COLORS:-true}"; then
				ask_yesno 462 "yes"
				if [ "${yesno}" = "y" ]; then
					if option_toggle "AirHack_EXTENDED_COLORS"; then
						echo
		...
		6)
			if "${AirHack_AUTO_CHANGE_LANGUAGE:-true}"; then
				ask_yesno 469 "no"
				if [ "${yesno}" = "y" ]; then
					if option_toggle "AirHack_AUTO_CHANGE_LANGUAGE"; then
						echo
		...
		7)
			if "${AirHack_SILENT_CHECKS:-true}"; then
				ask_yesno 577 "yes"
				if [ "${yesno}" = "y" ]; then
					if option_toggle "AirHack_SILENT_CHECKS"; then
						echo
		...
		8)
			if "${AirHack_PRINT_HINTS:-true}"; then
				ask_yesno 586 "yes"
				if [ "${yesno}" = "y" ]; then
					if option_toggle "AirHack_PRINT_HINTS"; then
						echo
		...
		9)
			if "${AirHack_5GHZ_ENABLED:-true}"; then
				ask_yesno 596 "yes"
				if [ "${yesno}" = "y" ]; then
					if option_toggle "AirHack_5GHZ_ENABLED"; then
						echo
		...
		10)
			if [ "${AirHack_WINDOWS_HANDLING}" = "xterm" ]; then
				ask_yesno 657 "yes"
				if [ "${yesno}" = "y" ]; then
					sed -ri "s:(AirHack_WINDOWS_HANDLING)=(xterm):\1=tmux:" "${rc_path}" 2> /dev/null
					echo
				...
				ask_yesno 658 "yes"
				if [ "${yesno}" = "y" ]; then
					sed -ri "s:(AirHack_WINDOWS_HANDLING)=(tmux):\1=xterm:" "${rc_path}" 2> /dev/null
					echo
					language_strings "${language}" 620 "yellow"
					language_strings "${language}" 115 "read"
				fi
		...
		12)
			...
			if [ "${yesno}" = "y" ]; then
				if option_toggle "AirHack_PLUGINS_ENABLED" "required_reboot"; then
					echo
					language_strings "${language}" 620 "yellow"
				else
					echo
		...
		13)
			if "${AirHack_FORCE_NETWORK_MANAGER_KILLING:-true}"; then
				ask_yesno 692 "yes"
				if [ "${yesno}" = "y" ]; then
					if option_toggle "AirHack_FORCE_NETWORK_MANAGER_KILLING"; then
						echo
			...
			if [ "${yesno}" = "y" ]; then
				...
				if [ "${language}" = "${current_permanent_language}" ]; then
					...
					if "${AirHack_AUTO_CHANGE_LANGUAGE:-true}"; then
						...
						option_toggle "AirHack_AUTO_CHANGE_LANGUAGE"
					fi
...
function handshake_capture_check() {
	...
	if [ "${AirHack_WINDOWS_HANDLING}" = "tmux" ]; then
...
function set_wep_key_script() {
	...
	cat >&8 <<-EOF
		#!/usr/bin/env bash
		AirHack_WINDOWS_HANDLING="${AirHack_WINDOWS_HANDLING}"
	EOF
	...
	cat >&8 <<-EOF
		...
		function manage_output() {
			...
			case "\${AirHack_WINDOWS_HANDLING}" in
				"tmux")
					local tmux_color
					tmux_color=""
...
function mdk_version_toggle() {
	...
	if [ "${AirHack_MDK_VERSION}" = "mdk3" ]; then
		sed -ri "s:(AirHack_MDK_VERSION)=(mdk3):\1=mdk4:" "${rc_path}" 2> /dev/null
		AirHack_MDK_VERSION="mdk4"
	else
		sed -ri "s:(AirHack_MDK_VERSION)=(mdk4):\1=mdk3:" "${rc_path}" 2> /dev/null
		AirHack_MDK_VERSION="mdk3"
	fi
...
function print_options() {
	...
	if [ "${AirHack_WINDOWS_HANDLING}" = "xterm" ]; then
		if grep -q "AirHack_WINDOWS_HANDLING=tmux" "${rc_path}" 2> /dev/null; then
			reboot_required_text="${reboot_required[${language}]}"
		fi
		language_strings "${language}" 618 "blue"
	else
		if grep -q "AirHack_WINDOWS_HANDLING=xterm" "${rc_path}" 2> /dev/null; then
			reboot_required_text="${reboot_required[${language}]}"
		fi
	...
	reboot_required_text=""
	if "${AirHack_PLUGINS_ENABLED:-true}"; then
		if grep -q "AirHack_PLUGINS_ENABLED=false" "${rc_path}" 2> /dev/null; then
			reboot_required_text="${reboot_required[${language}]}"
		fi
		language_strings "${language}" 653 "blue"
	else
		if grep -q "AirHack_PLUGINS_ENABLED=true" "${rc_path}" 2> /dev/null; then
			reboot_required_text="${reboot_required[${language}]}"
		fi
...
function clean_env_vars() {
	...
	unset AirHack_AUTO_UPDATE AirHack_SKIP_INTRO AirHack_BASIC_COLORS AirHack_EXTENDED_COLORS AirHack_AUTO_CHANGE_LANGUAGE AirHack_SILENT_CHECKS AirHack_PRINT_HINTS AirHack_5GHZ_ENABLED AirHack_FORCE_IPTABLES AirHack_FORCE_NETWORK_MANAGER_KILLING AirHack_MDK_VERSION AirHack_PLUGINS_ENABLED AirHack_DEVELOPMENT_MODE AirHack_DEBUG_MODE AirHack_WINDOWS_HANDLING
}
...
function prepare_captive_portal_data() {
	...
	if [ "${advanced_captive_portal}" -eq 1 ]; then
		...
		if [ "${cp_vendor_detected}" = "0" ]; then
			...
			captive_portal_brand="AirHack_default"
...
function set_beef_config() {
	...
	{
	echo -e "beef:"
	echo -e "    version: 'AirHack integrated'"
	echo -e "    debug: false"
...
#Rewrite AirHack script in a polymorphic way adding custom beef location to array to get persistence
...
function iptables_nftables_detection() {
	...
	if ! "${AirHack_FORCE_IPTABLES:-false}"; then
...
function set_script_paths() {
	...
	plugins_paths=(
					...
					"${user_homedir}.AirHack/${plugins_dir}"
				)
}
...
function update_options_config_file() {
	...
	case "${1}" in
		"getdata")
			readarray -t OPTION_VARS < <(grep "AirHack_" "${rc_path}" 2> /dev/null)
		;;
		"writedata")
			local option_name
			local option_value
...
function check_root_permissions() {
	...
	if [ "${user}" = "root" ]; then
		if ! "${AirHack_SILENT_CHECKS:-false}"; then
			echo
...
function env_vars_initialization() {
	...
	ordered_options_env_vars=(
									"AirHack_AUTO_UPDATE" #0
									"AirHack_SKIP_INTRO" #1
									"AirHack_BASIC_COLORS" #2
									"AirHack_EXTENDED_COLORS" #3
									"AirHack_AUTO_CHANGE_LANGUAGE" #4
									"AirHack_SILENT_CHECKS" #5
									"AirHack_PRINT_HINTS" #6
									"AirHack_5GHZ_ENABLED" #7
									"AirHack_FORCE_IPTABLES" #8
									"AirHack_FORCE_NETWORK_MANAGER_KILLING" #9
									"AirHack_MDK_VERSION" #10
									"AirHack_PLUGINS_ENABLED" #11
									"AirHack_DEVELOPMENT_MODE" #12
									"AirHack_DEBUG_MODE" #13
									"AirHack_WINDOWS_HANDLING" #14
									)
...
#Detect if AirHack is working inside a docker container
...
function initialize_extended_colorized_output() {
	...
	colorize=""
	if "${AirHack_BASIC_COLORS:-true}" && "${AirHack_EXTENDED_COLORS:-true}"; then
		if hash ccze 2> /dev/null; then
			colorize="| ccze -A"
		fi
	fi
...
#Kill tmux session started by AirHack
...
#Starting point of AirHack script inside newly created tmux session
function start_AirHack_from_tmux() {
...
#Create new tmux session exclusively for AirHack
function create_tmux_session() {
	...
	if [ "${2}" = "true" ]; then
		...
		start_AirHack_from_tmux "normal"
	else
		tmux new-session -d -s "${1}"
		start_AirHack_from_tmux "nested"
	fi
}
...
#shellcheck disable=SC2009
function close_existing_AirHack_tmux_session() {

	debug_print

	if ! check_inside_tmux; then
		eval "kill -9 $(ps --no-headers aux | grep -i 'tmux.*AirHack' | awk '{print $2}' | tr '\n' ' ') > /dev/null 2>&1"
	fi
}
...
function transfer_to_tmux() {
	...
	close_existing_AirHack_tmux_session
...
function validate_plugin_requirements() {
	...
	if [ -n "${plugin_minimum_ag_affected_version}" ]; then
		if compare_floats_greater_than "${plugin_minimum_ag_affected_version}" "${AirHack_version}"; then
			return 1
		fi
	fi

	if [ -n "${plugin_maximum_ag_affected_version}" ]; then
		if compare_floats_greater_than "${AirHack_version}" "${plugin_maximum_ag_affected_version}"; then
			return 1
		fi
	fi
...
#Check for access to AirHack repository
...
function autoupdate_check() {
	...
	if check_repository_access; then
		...
		AirHack_last_version=$(timeout -s SIGTERM 15 curl -L ${urlscript_directlink} 2> /dev/null | grep "AirHack_version=" | head -n 1 | cut -d "\"" -f 2)

		if [ -n "${AirHack_last_version}" ]; then
			version_checked=1
		else
			http_proxy_detect
			if [ "${http_proxy_set}" -eq 1 ]; then

				AirHack_last_version=$(timeout -s SIGTERM 15 curl --proxy "${http_proxy}" -L ${urlscript_directlink} 2> /dev/null | grep "AirHack_version=" | head -n 1 | cut -d "\"" -f 2)
				if [ -n "${AirHack_last_version}" ]; then
					version_checked=1
				else
					language_strings "${language}" 5 "yellow"
		...
		if [ "${version_checked}" -eq 1 ]; then
			if compare_floats_greater_than "${AirHack_last_version}" "${AirHack_version}"; then
...
function main() {
	...
	if ! "${AirHack_DEVELOPMENT_MODE:-false}"; then
		if ! "${AirHack_SKIP_INTRO:-false}"; then
			language_strings "${language}" 86 "title"
